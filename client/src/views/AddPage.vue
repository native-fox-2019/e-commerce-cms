  ...
  <div class="divCenter">
    <form  v-on:submit.prevent="submitAdd()">
      ...
      <div class="containerForm">
          ...
          placeholder="e.g. Batman new 52" v-model="name">
      </div>
      ...
      <div class="containerForm">
          <input type="number" class="input inputText" placeholder="1" v-model="stock">
      </div>
      <div class="containerForm"> <span class="textForm"> Price </span> </div>
      <div class="containerForm">
           <input type ="number" v-model="price" class="input inputText" placeholder="harga">
      </div>
          <div class="containerForm">
              <input class="btn" type="submit" value="Add Watch">
          </div>
  </form>
  </div>
</template>
