...
<div class="container-fluid">
	<div class="movie-card" style="margin-top:5em">
		<div class="movie-header manOfSteel">
			<div class="header-icon-container text-center">
    <img style="	background-size: cover;" src="http://henrycavill.org/images/Films/2013-Man-of-Steel/posters/3-Walmart-Superman-a.jpg" alt="">
				<a href="#">
