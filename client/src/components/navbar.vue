<template>
  ...
  <form class="form-inline float-right my-2 h-1">
    <input style="border-radius:40px;" class="form-control mr-sm-2" type="search" placeholder="Search by Category" aria-label="Search">
